...
begin
Select @maxdate = max(date) from [deendayal antyodaya yojana nrlm] where project_code=@schemecode
if (@stateid=0 and @kpiid =0)
begin
select state_code,state_name,data_freq,[Date],project_code,project_name,indicator,sum([value]) as national_value
...
select  state_code,state_name,data_freq,[Date],project_code,project_name,indicator,sum([value]) as national_value
from [deendayal antyodaya yojana nrlm]
where project_code=100156 and  [date]=case when @datevalue='' then @maxdate  else @datevalue end
group by  state_code,state_name,project_code,project_name,[label],indicator,data_freq,[Date]
...
begin
Select @maxdate = max(date) from [pradhan mantri gram sadak yojana] 
if (@stateid=0 and @kpiid =0)
begin
select state_code,state_name,data_freq,[Date],project_code,project_name,indicator,sum([value]) as national_value
...
begin
Select @maxdate = max(date) from [onorc_v3] WHERE project_code=@schemecode
if (@stateid=0 and @kpiid =0)
begin
select state_code,state_name,data_freq,[Date],project_code,project_name,indicator,sum([value]) as national_value
from [onorc_v3]
where  project_code=100565 and [date]=case when @datevalue='' then @maxdate  else @datevalue end
group by state_code,state_name,project_code,project_name,[label],indicator,data_freq,[Date]
order by [label],state_code
...
select state_code,state_name,data_freq,[Date],project_code,project_name,indicator,sum([value]) as national_value
from [onorc_v3]
where  project_code=100646 and [date]=case when @datevalue='' then @maxdate  else @datevalue end
group by state_code,state_name,project_code,project_name,[label],indicator,data_freq,[Date]
order by state_code,[label]
...
begin
Select @maxdate = max(date) from [pm_awaas_yojana_urban_weekly] 
if (@stateid=0 and @kpiid =0)
begin
select state_code,state_name,data_freq,[Date],project_code,project_name,indicator,sum([value]) as national_value
...
begin
Select @maxdate = max(date) from [ujala] 
if (@stateid=0 and @kpiid =0)
begin
select state_code,state_name,data_freq,[Date],project_code,project_name,indicator,sum([value]) as national_value
from [ujala]
