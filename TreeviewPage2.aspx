<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TreeViewPage2.aspx.cs" Inherits="TreeView.TreeviewPage2" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <title>Task Status Hirerachy </title>
    <style>
        body {
        ...
        <div class="floating-tree">
            <ul class="tree">
                <li><span>Set Your Hirearchy</span> 
                    <ul>
                        <li><span>level 1 </span> <input type="text" id="txtlevel1" placeholder="Name your Level 1" /></li>
                        <li><span>level 2</span> <input type="text" id="txtlevel2" placeholder="Name your Level 2"/></li>
                        <li><span>level 3</span> <input type="text" id="txtlevel3" placeholder="Name your Level 3"/></li>
                        <li><span>level 4 </span> <input type="text" id="txtlevel4" placeholder="Name your Level 4" /></li>
                        <li><span>level 5</span> <input type="text" id="txtlevel5" placeholder="Name your Level 5"/></li>
                        <li><span>level 6</span> <input type="text" id="txtlevel6" placeholder="Name your Level 6"/></li>
                        <li><span>level 7</span> <input type="text" id="txtlevel7" placeholder="Name your Level 7" /></li>
                        <li><span>level 8</span> <input type="text" id="txtlevel8" placeholder="Name your Level 8"/></li>
                        <li><span>level 9</span> <input type="text" id="txtlevel9" placeholder="Name your Level 9"/></li>
                        <li><span>level 10</span> <input type="text" id="txtlevel10" placeholder="Name your Level 10"/></li>
                    </ul>
                </li>
            </ul>        
    ...
    <script>
        ...
        function onSubmitForm() {
            ...
            try {
                $.ajax({
                    type: "POST",
                    url: "TreeviewPage2.aspx/saverecord",
