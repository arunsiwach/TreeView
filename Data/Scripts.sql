...
-- =============================================             
 ...
 @scheme_code int,              
 @kpiid int,      
 @datevalue varchar(30)----Add date filter       
 )              
AS              
BEGIN              
...
and c.Datadt=(select max(Datadt) from Tbl_DataPort_KPI_PORTED_DATA where project_code=@scheme_code and Datadt<=@datevalue )              
...
select @maxdate=max(Datadt) from Tbl_DataPort_KPI_PORTED_DATA where project_code=@scheme_code and Datadt<=@datevalue  
...
--Add date filter       
and Datadt = @maxdate --case when @datevalue='' then Datadt else @datevalue end      
